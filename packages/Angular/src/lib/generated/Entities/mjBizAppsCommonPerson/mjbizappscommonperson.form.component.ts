...
export class mjBizAppsCommonPersonFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'mJBizAppsIssuesIssuesReporterPersonID', sectionName: 'Issues (Reporter Person ID)', isExpanded: false },
            { sectionKey: 'mJBizAppsOrdersCustomerTaxExemptions', sectionName: 'Customer Tax Exemptions', isExpanded: false },
            { sectionKey: 'mJBizAppsIssuesIssuesCreatedByPersonID', sectionName: 'Issues (Created By Person ID)', isExpanded: false },
            ...
            { sectionKey: 'mJBizAppsOrdersOrderHeadersBillToPersonID', sectionName: 'Orders', isExpanded: false },
