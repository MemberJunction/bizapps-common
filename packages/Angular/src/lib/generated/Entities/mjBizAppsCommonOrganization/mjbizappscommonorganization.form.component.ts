...
export class mjBizAppsCommonOrganizationFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'locationAndAddress', sectionName: 'Location and Address', isExpanded: true },
            { sectionKey: 'organizationMetrics', sectionName: 'Organization Metrics', isExpanded: true },
