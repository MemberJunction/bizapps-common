...
mj app info memberjunction-bizapps     # Show details and version
mj app upgrade memberjunction-bizapps  # Upgrade to latest release
mj app disable memberjunction-bizapps  # Temporarily disable
mj app enable memberjunction-bizapps   # Re-enable
mj app remove memberjunction-bizapps   # Uninstall (--keep-data to preserve schema)
```
